...
from keras.layers import Input, Dense, Convolution2D, Flatten, merge, Deconvolution2D, Activation, Lambda
...
class trainDNNFull(object):
    ...
    def __init__(self, root, noise, option):
        ...
        self.input_file_images_training = "/scratch1/aasensio/deepLearning/phaseDiv/database/database_images.h5"
        self.input_file_images_validation = "/scratch1/aasensio/deepLearning/phaseDiv/database/database_images_validation.h5"
