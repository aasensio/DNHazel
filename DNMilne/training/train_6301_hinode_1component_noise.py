...
# Stokes I
        ...
        x = GaussianNoise(self.sigma_noise[0])(x)
        x = Convolution1D(nb_filter=self.nFeatures, filter_length=self.kernelSize, activation='relu', border_mode='valid', init='he_normal', name='convI_1')(x)
...
# Stokes Q        
        ...
        x = GaussianNoise(self.sigma_noise[1])(x)
        x = Convolution1D(nb_filter=self.nFeatures, filter_length=self.kernelSize, activation='relu', border_mode='valid', init='he_normal', name='convQ_1')(x)
...
# Stokes U
        ...
        x = GaussianNoise(self.sigma_noise[2])(x)
        x = Convolution1D(nb_filter=self.nFeatures, filter_length=self.kernelSize, activation='relu', border_mode='valid', init='he_normal', name='convU_1')(x)
...
# Stokes V
        ...
        x = GaussianNoise(self.sigma_noise[3])(x)
        x = Convolution1D(nb_filter=self.nFeatures, filter_length=self.kernelSize, activation='relu', border_mode='valid', init='he_normal', name='convV_1')(x)
