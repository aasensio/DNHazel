...
# Only allocate needed memory
        ...
        self.input_file_images_training = "/net/duna/scratch1/aasensio/deepLearning/opticalFlow/database/database_images.h5"
        self.input_file_velocity_training = "/net/duna/scratch1/aasensio/deepLearning/opticalFlow/database/database_velocity.h5"

        self.input_file_images_validation = "/net/duna/scratch1/aasensio/deepLearning/opticalFlow/database/database_images_validation.h5"
        self.input_file_velocity_validation = "/net/duna/scratch1/aasensio/deepLearning/opticalFlow/database/database_velocity_validation.h5"
    ...
    def training_generator(self):
        ...
        while 1:        
            for i in range(self.batchs_per_epoch_training):
                ...
                output_train = velocity[i*self.batch_size:(i+1)*self.batch_size,:,:,6:].astype('float32')
    ...
    def validation_generator(self):
        ...
        while 1:        
            for i in range(self.batchs_per_epoch_validation):
                ...
                output_validation = velocity[i*self.batch_size:(i+1)*self.batch_size,:,:,6:].astype('float32')
    ...
    def define_network(self):
        ...
        final = Convolution2D(3, (1, 1), activation='linear', padding='same', kernel_initializer='he_normal')(x)
