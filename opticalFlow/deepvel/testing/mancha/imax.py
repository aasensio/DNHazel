...
def run_slave():    
    while True:
        ...
        if tag == tags.START:            
            ...
            dataToSend = {'index': task_index, 'image': im, 'vx1': vx1, 'vz1': vz1, 'vx01': vx01, 'vz01': vz01, 'vx001': vx001, 'vz001': vz001}
...
if rank == 0: 
    ...
    fi = h5py.File('/scratch1/aasensio/deepLearning/opticalFlow/database/int_imax_degraded.h5', 'w')
    fv = h5py.File('/scratch1/aasensio/deepLearning/opticalFlow/database/v_imax_degraded.h5', 'w')

    db_images = fi.create_dataset("image", (82+53, 830, 830), dtype='float32')
    db_vel = fv.create_dataset("vel", (6, 82+53, 830, 830), dtype='float32')
