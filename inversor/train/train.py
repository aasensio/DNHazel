...
# Only allocate needed memory
        ...
        self.input_training = "../database/training_nicole.h5"
        
        f = h5py.File(self.input_training, 'r')
        self.n_training = len(f['models'])
        f.close()

        self.input_validation = "../database/validation_nicole.h5"
        
        f = h5py.File(self.input_validation, 'r')
        self.n_validation = len(f['models'])
        f.close()
...
if (__name__ == '__main__'):
    ...
    parser.add_argument('-o','--output', help='Output files', default='networks/test')
