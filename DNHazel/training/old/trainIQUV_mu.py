...
# Stokes V
    ...
    def trainCNN(self, nIterations):
        ...
        self.metrics = self.model.fit(self.inTrain, self.outTrain, batch_size=self.batchSize, 
            nb_epoch=nIterations, validation_split=0.1, shuffle=True, callbacks=[self.checkpointer, self.history])
...
if (__name__ == '__main__'):
    ...
    parser.add_argument('-o','--out', help='Output files', required=True)
    parser.add_argument('-e','--epochs', help='Number of epochs', required=True, default=10)
